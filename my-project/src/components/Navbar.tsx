...
const Navbar = ({ currentPage }: NavbarProps) => {
  return (
    <nav className="top-0 left-0 right-0 p-4 flex justify-between items-center border-b border-gray-200 font-neue-montreal" role="navigation" aria-label="Main navigation">
